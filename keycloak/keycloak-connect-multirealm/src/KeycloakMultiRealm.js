...
const Admin = require(path.join(process.cwd(), './keycloak/keycloak-connect/middleware/admin'));
const Logout = require(path.join(process.cwd(), './keycloak/keycloak-connect/middleware/logout'));
const PostAuth = require(path.join(process.cwd(), './keycloak/keycloak-connect/middleware/post-auth'));
const GrantAttacher = require(path.join(process.cwd(), './keycloak/keycloak-connect/middleware/grant-attacher'));
const Protect = require(path.join(process.cwd(), './keycloak/keycloak-connect/middleware/protect'));
const Enforcer = require(path.join(process.cwd(), './keycloak/keycloak-connect/middleware/enforcer'));
